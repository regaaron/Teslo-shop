...
export const ProductForm = ({ title, subTitle, product, onSubmit }: Props) => {
  ...
  const addTag = () => {
    ...
    newTagSet.add(inputRef.current!.value);
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={cn(
                      "w-full px-4 py-3 border border-slate-300 rounded-lg transition-all duration-200 outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent",
                      {
